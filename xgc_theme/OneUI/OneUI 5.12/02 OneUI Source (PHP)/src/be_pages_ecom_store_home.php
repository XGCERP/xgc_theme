...
<div class="content content-full content-boxed">
  ...
  <div class="text-end">
    <a class="fs-sm fw-semibold link-fx" href="be_pages_ecom_store_products.php">View More New Arrivals..</a>
  </div>
  <!-- END New Arrivals -->
  ...
  <div class="text-end">
    <a class="fs-sm fw-semibold link-fx" href="be_pages_ecom_store_products.php">View More Best Sellers..</a>
  </div>
  <!-- END Best Sellers -->
  ...
  <div class="text-end">
    <a class="fs-sm fw-semibold link-fx" href="be_pages_ecom_store_products.php">View More Best Rated..</a>
  </div>
  <!-- END Best Rated -->
</div>
<!-- END Page Content -->
...
<div class="bg-body-dark">
  <div class="content content-full">
    <div class="my-5 text-center">
      ...
      <a class="btn btn-primary px-4 py-2" href="be_pages_ecom_store_products.php">
